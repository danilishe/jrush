...
/*
            if (operation == Operation.CREATE) {
                ConsoleHelper.writeMessage("Скажите, что паковать: ");
                Path newPath = Paths.get(ConsoleHelper.readString());
                FileManager manager = new FileManager(newPath);
                for (Path path : manager.getFileList()) {
